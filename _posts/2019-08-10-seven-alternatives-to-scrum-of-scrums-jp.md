...
2001年に、ケン・シュワバーとマイク・ビードルが初めてスクラムを扱った本を出版しました。これは、その不愉快な表紙にちなんで「ブラックブック」と呼ばれています。本書は、抽象的な理論の大集合であり、スクラムをいかに実践するかという側面には、小規模でさえも、ましてや複数チーム規模ではほとんど触れらていません。このブラックブックには、複数チームからのスクラムマスターが定期的に打ち合わせし調整するという概念が含まれていたのです。概念には、「スクラム・オブ・スクラムズ」という、心をそそるような概念の自己相似性を反映したタイトルがついています。
