...
![スクラム・オブ・スクラムは最悪だ](/images/scrum-of-scrums-sucks.png){: .align-center width="400"}
...
![壁を壊せ!](/images/tear-down-the-wall.png){: .align-center width="400"}
...
あいにく、[局所最適化志向](/local-optimization-bias-jp/) のスクラムマスターは、これを妨げようとすることがあります！逆に、プロダクト全体思考を持ったスクラムマスターは、これを可能にする努力を惜しまないでしょう。
